...
def send_vmulti_report_wacom_ii(vmulti_device_report, proximity: bool, pointer: bool, pos_x: int, pos_y: int, buttons: int, button_flag: bool, pressure: int) -> None:  # noqa: ANN001
    ...
    scaled_pressure = int(pressure / WACOM_II_MAX_PRESSURE * 8191)
