...
from internal_constants import (
    ...
    VMULTI_ID,
    WACOM_IV_1_2_TO_1_4_MAX_PRESSURE,
)
from user_constants import PRESSURE_DEADZONE, PRESSURE_OFFSET

report = [0x00]*65

def send_vmulti_report_wacom_iv_1_2_to_1_4(vmulti_device_report, proximity: bool, pointer: bool, button_flag: bool, pos_x: int, pos_y: int, buttons: int, pressure: int) -> None:  # noqa: ANN001
