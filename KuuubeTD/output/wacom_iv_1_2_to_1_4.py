from internal_constants import VMULTI_ID, USAGE_PAGE_DIGITIZER, OUTPUT_MODE, WACOM_IV_1_2_TO_1_4_MAX_PRESSURE
from user_constants import PRESSURE_OFFSET, PRESSURE_DEADZONE
import tablet_monitor_mapping

report = [0x00]*65

def send_vmulti_report_wacom_iv_1_2_to_1_4(vmulti_device_report, proximity, pointer, button_flag, pos_x, pos_y, buttons, pressure):    
    ...
    scaled_pressure = int(pressure / WACOM_IV_1_2_TO_1_4_MAX_PRESSURE * 8191)
