...
from internal_constants import (
    ...
    VMULTI_ID,
    WACOM_V_2_0_MAX_PRESSURE,
    WACOM_V_2_0_MAX_TILT,
)
from user_constants import PRESSURE_DEADZONE, PRESSURE_OFFSET

report = [0x00]*65

def send_vmulti_report_wacom_v_2_0(vmulti_device_report, proximity: bool, pointer: bool, button_flag: bool, pos_x: int, pos_y: int, buttons: int, pressure: int, tilt_x: int, tilt_y: int) -> None:  # noqa: ANN001
