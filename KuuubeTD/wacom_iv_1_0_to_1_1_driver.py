...
while(True):
    ...
    vmulti_handler.send_report_wacom_iv_1_0_to_1_1(vmulti_device_report, report_parsed[0], report_parsed[1], report_parsed[2], report_parsed[3], report_parsed[4], report_parsed[5], report_parsed[6])
