...
from internal_constants import (
    ...
    SERIAL_PORT_TIMEOUT,
    WACOM_V_2_0_SETTINGS_COMMAND,
)
from user_constants import SERIAL_PORT_PATH


def setup_wacom_v_2_0(port: str = SERIAL_PORT_PATH, baudrate: int = SERIAL_PORT_INITIAL_BAUD_RATE, bytesize: int = SERIAL_PORT_BYTESIZE, timeout: int = SERIAL_PORT_TIMEOUT, stopbits: int = SERIAL_PORT_STOPBITS) -> serial.Serial:
