...
def setup_wacom_ii_s(port: str = SERIAL_PORT_PATH, baudrate: int = SERIAL_PORT_INITIAL_BAUD_RATE, bytesize: int = SERIAL_PORT_BYTESIZE, timeout: int = SERIAL_PORT_TIMEOUT, stopbits: int = SERIAL_PORT_STOPBITS) -> serial.Serial:
