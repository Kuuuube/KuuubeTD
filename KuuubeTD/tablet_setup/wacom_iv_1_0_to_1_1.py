import serial
from internal_constants import SERIAL_PORT_INITIAL_BAUD_RATE, SERIAL_PORT_BYTESIZE, SERIAL_PORT_TIMEOUT, SERIAL_PORT_STOPBITS, SERIAL_PORT_FINAL_BAUD_RATE, WACOM_IV_1_0_TO_1_1_SETTINGS_COMMAND
